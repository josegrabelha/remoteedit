...
<div id="binaryLogConfirmBackdrop" class="confirm-dialog-backdrop" role="dialog" aria-modal="true" aria-labelledby="binaryLogConfirmTitle" aria-hidden="true">
  <section class="confirm-dialog">
    <header class="confirm-dialog-header"><h2 id="binaryLogConfirmTitle" class="confirm-dialog-title">Binary data detected</h2></header>
    <div class="confirm-dialog-body">
      <p id="binaryLogConfirmMessage" class="confirm-dialog-message">This file appears to contain binary data. Opening it in Log Viewer may display incorrectly, affect performance, or cause unexpected issues.</p>
