...
<div id="closeTabConfirmBackdrop" class="confirm-dialog-backdrop" role="dialog" aria-modal="true" aria-labelledby="closeTabConfirmTitle" aria-hidden="true">
  <section class="confirm-dialog">
    <header class="confirm-dialog-header"><h2 id="closeTabConfirmTitle" class="confirm-dialog-title">Close log tab?</h2></header>
    <div class="confirm-dialog-body">
      <p id="closeTabConfirmMessage" class="confirm-dialog-message">Closing this tab will remove the loaded log content.</p>
