export function renderRemoteCommandOutput(): string {
  ...
  const MANAGE_ICON_CLONE = '<svg viewBox="0 -960 960 960" focusable="false" aria-hidden="true"><path d="M360-160q-33 0-56.5-23.5T280-240v-480q0-33 23.5-56.5T360-800h360q33 0 56.5 23.5T800-720v480q0 33-23.5 56.5T720-160H360Zm0-40h360q16 0 28-12t12-28v-480q0-16-12-28t-28-12H360q-16 0-28 12t-12 28v480q0 16 12 28t28 12ZM200-320q-33 0-56.5-23.5T120-400v-400q0-33 23.5-56.5T200-880h320v40H200q-16 0-28 12t-12 28v400q0 16 12 28t28 12v40Zm120-440v560-560Z"></path></svg>';
  ...
  function handleManageProfilesClick(event) {
    ...
    if (action === 'clone') {
      setBusy(true, 'Cloning saved connection...');
      vscode.postMessage({ type: 'cloneConnection', payload: { id: profileId } });
      return;
    }
