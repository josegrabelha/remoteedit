export function renderServerOverviewLists(): string {
  ...
  function renderServerQuickTasks() {
    ...
    const header = '<div class="server-section-title-row server-quick-tasks-title-row"><div class="server-section-title-wrap"><div class="server-section-title">Saved Commands</div><span class="server-section-count">' + escapeHtml(countLabel) + '</span></div><div class="server-section-title-right"><div class="server-section-title-actions">' + addButton + '</div><span class="server-section-title-separator" aria-hidden="true"></span>' + filterBox + '</div></div>';
  ...
  function renderServerLogs(session) {
    ...
    const header = '<div class="server-section-title-row server-logs-title-row"><div class="server-section-title-wrap"><div class="server-section-title">Log Shortcuts</div><span class="server-section-count">' + escapeHtml(countDetail) + '</span></div><div class="server-section-title-right"><div class="server-section-title-actions">' + addButton + '</div><span class="server-section-title-separator" aria-hidden="true"></span>' + filterBox + '</div></div>';
