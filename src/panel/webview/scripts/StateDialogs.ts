export function renderStateDialogs(showRemotePathBreadcrumbDirectoryDetails: boolean, openFileListItemsOnNameClick: boolean, permissionsDisplayMode: string): string {
  ...
  const serverPortForwardDirectionLocalButton = document.getElementById('serverPortForwardDirectionLocalButton');
  const serverPortForwardDirectionRemoteButton = document.getElementById('serverPortForwardDirectionRemoteButton');
  const serverPortForwardNameInput = document.getElementById('serverPortForwardNameInput');
  const serverPortForwardLocalHostLabel = document.getElementById('serverPortForwardLocalHostLabel');
  const serverPortForwardLocalHostInput = document.getElementById('serverPortForwardLocalHostInput');
  const serverPortForwardLocalPortLabel = document.getElementById('serverPortForwardLocalPortLabel');
  const serverPortForwardLocalPortInput = document.getElementById('serverPortForwardLocalPortInput');
  const serverPortForwardRemoteHostLabel = document.getElementById('serverPortForwardRemoteHostLabel');
  const serverPortForwardRemoteHostInput = document.getElementById('serverPortForwardRemoteHostInput');
  const serverPortForwardRemotePortLabel = document.getElementById('serverPortForwardRemotePortLabel');
  ...
  const serverPortForwardHelp = document.getElementById('serverPortForwardHelp');
  ...
  let serverPortForwardDialogDirection = 'local';
